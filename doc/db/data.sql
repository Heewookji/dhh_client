...
insert into question(character_id, text) VALUES (8, '친해지고 싶은 사람 있었어?'|| char(10) ||'왜 친해지고 싶었어?');
insert into question(character_id, text) VALUES (8, '오늘 다른 사람과의 거리감은 어땠어?');
insert into question(character_id, text) VALUES (8, '오늘 나는 주변 사람들에게'|| char(10) ||'표현을 많이 하는 사람이었어?');
insert into question(character_id, text) VALUES (8, '만나고 싶지 않은 사람은 있었어?');
insert into question(character_id, text) VALUES (8, '친구, 가족, 회사, 학교 등의'|| char(10) ||'집단마다 나는 다른 성향이야?');
insert into question(character_id, text) VALUES (8, '이성 친구와 동성 친구'|| char(10) ||'어느 쪽을 중시하는 편이야?');
insert into question(character_id, text) VALUES (8, '친구들과 있을 때 어떤 주제를 주로 말해?');
insert into question(character_id, text) VALUES (8, '나를 많이 생각해주는 사람들을'|| char(10) ||'만날 기회가 있었어?');
...
insert into question(character_id, text) VALUES (8, '내가 소중히 여기는 사람들도'|| char(10) ||'나를 소중히 대해주는 것 같아?');
insert into question(character_id, text) VALUES (8, '내게 잘해주지만 귀찮은 친구라고'|| char(10) ||'느낄 때, 어떻게 행동해?');
insert into question(character_id, text) VALUES (8, '친구와 거리감을 느낄 때가 있어?');
insert into question(character_id, text) VALUES (8, '당연하게 내 곁에 계시던 부모님께서'|| char(10) ||'떠난다는 생각을 해봤어?');
...
insert into question(character_id, text) VALUES (3, '내가 사랑하는 사람이 좋아 아니면'|| char(10) ||'나를 사랑해주는 사람이 좋아?');
...
insert into question(character_id, text) VALUES (3, '친구와의 우정에서 가장 중요하다고'|| char(10) ||'생각하는 것은 뭐야?');
...
insert into question(character_id, text) VALUES (3, '너의 최애 카페음료는 뭐야?'|| char(10) ||'왜 그 음료를 선택했어?');
...
insert into question(character_id, text) VALUES (3, 'cc나 사내 연애에 대한 로망이 있어?'|| char(10) ||'어떻게 생각해?');
insert into question(character_id, text) VALUES (3, '가장 사랑하는 연예인은 누구야?');
insert into question(character_id, text) VALUES (3, '스스로를 사랑하는 인생은'|| char(10) ||'어떤 것이라고 생각해?');
...
insert into question(character_id, text) VALUES (3, '좋아하는 것과 사랑하는 것은'|| char(10) ||'어떤 차이가 있을까?');
insert into question(character_id, text) VALUES (3, '연애를 하면 좋은 점이 무엇이 있을까?');
insert into question(character_id, text) VALUES (3, '먼저 마음을 고백할만큼'|| char(10) ||'좋아했던 사람이 있어?');
...
insert into question(character_id, text) VALUES (7, 'SNS 좋아해? 하게 된 계기는 뭐야?'|| char(10) ||'안한다면 왜 안해?');
insert into question(character_id, text) VALUES (7, '좋아하는 취미 분야의 유투버가 있어?');
insert into question(character_id, text) VALUES (7, '집에서 영화보는게 좋아?'|| char(10) ||'영화관에서 영화보는게 좋아?');
...
insert into question(character_id, text) VALUES (7, '한 달 동안 외국에서 살아야 한다면'|| char(10) ||'가고 싶은 나라는?');
insert into question(character_id, text) VALUES (7, '좋아하는 tv 프로그램 있어?'|| char(10) ||'왜 좋아해?');
insert into question(character_id, text) VALUES (7, '새로운 친구를 사귄다면'|| char(10) ||'어떤 취미의 사람들을 만나고 싶어?');
insert into question(character_id, text) VALUES (7, '꼭 해보고 싶은 취미 활동이 있을까?');
insert into question(character_id, text) VALUES (7, '무언가를 수집하고 있거나'|| char(10) ||'모아보고 싶은 게 있어?');
insert into question(character_id, text) VALUES (7, '어떤 취미 활동에 푹 빠져본 적 있어?'|| char(10) ||'어떤 취미였어?');
insert into question(character_id, text) VALUES (7, '''자유여행 VS 패키지 여행'''|| char(10) ||'당신의 선택은?');
insert into question(character_id, text) VALUES (7, '나만의 여가 생활을 만들기 위해'|| char(10) ||'어떤 노력을 했어?');
insert into question(character_id, text) VALUES (7, '같이 취미 활동하는 데'|| char(10) ||'잘 맞을 것 같은 친구 유형은?');
insert into question(character_id, text) VALUES (7, '기억에 남는 축제가 있어?');
insert into question(character_id, text) VALUES (7, '나는 친구들과 카페에서 수다 떨면'|| char(10) ||'스트레스가 풀리더라~ 너는?');
...
insert into question(character_id, text) VALUES (7, '주변에 특별한 취미를 가진 사람이 있어?'|| char(10) ||'어떤거야?');
-- 1,'뭉그리'
-- 2,'똘똘이',
-- 3,'달콩이'
-- 4,'부우'
...
insert into question(character_id, text) VALUES (4, '시간을 돌릴 수 있다면'|| char(10) ||'돌려버리고 싶은 일이 있었어?');
...
insert into question(character_id, text) VALUES (4, '나를 부정적 감정으로 몰아넣은'|| char(10) ||'사람이나 사건이 있었어?');
...
insert into question(character_id, text) VALUES (4, '다른 사람을 무시하며 자신을'|| char(10) ||'추켜세우는 사람을 만난 적이 있어?');
...
insert into question(character_id, text) VALUES (6, '너는 달달한 음식 좋아해?'|| char(10) ||'뭐 좋아해?');
insert into question(character_id, text) VALUES (6, '너의 최애 카페음료는 뭐야?'|| char(10) ||'왜 그 음료를 선택했어?');
insert into question(character_id, text) VALUES (6, '과자나 초콜릿 등을 좋아하니?'|| char(10) ||'어떤 추억이 있어?');
...
insert into question(character_id, text) VALUES (6, '제일 좋아하는 빵은?'|| char(10) ||'빵에 대한 추억은?');
insert into question(character_id, text) VALUES (6, '너는 라면을 좋아해?'|| char(10) ||'좋아한다면 어떤 라면을 좋아해?');
insert into question(character_id, text) VALUES (6, '오늘 뭐 먹었어?');
insert into question(character_id, text) VALUES (6, '너는 치킨을 좋아해?'|| char(10) ||'어떤 날에 치킨을 주로 먹어?');
...
insert into question(character_id, text) VALUES (6, '너가 싫어하는 음식은 뭐야?'|| char(10) ||'어릴 때랑 비교했을 때 어떻게 변했어?');
insert into question(character_id, text) VALUES (6, '중국집에 가면 어떤 음식을 자주 시켜먹니?');
insert into question(character_id, text) VALUES (6, '만약 아무리 먹어도 살이 안찐다면'|| char(10) ||'가장 먹고 싶은 음식들은?');
...
insert into question(character_id, text) VALUES (6, '세계 어느 나라든지 당장 갈 수 있다면'|| char(10) ||'거기서 가장 먹고 싶은 음식이 뭐야?');
...
insert into question(character_id, text) VALUES (10, '몸이 아플 때 가장 생각나는'|| char(10) ||'사람이 누구야?');
insert into question(character_id, text) VALUES (10, '생일에 받고 싶은 선물은?'|| char(10) ||'누구에게 받고 싶어?');
insert into question(character_id, text) VALUES (10, '너만의 소확행'|| char(10) ||'(소소하지만 확실한 행복)은?');
insert into question(character_id, text) VALUES (10, '혼자 독립해서 살면서'|| char(10) ||'가장 하고 싶은 일은 뭐야?');
insert into question(character_id, text) VALUES (10, '지금까지 본 영화 중에'|| char(10) ||'가장 인상 깊었던 영화는 뭐야?');
insert into question(character_id, text) VALUES (10, '지금 당장 여행을 떠날 수 있다면'|| char(10) ||'어디로 가고 싶어?');
insert into question(character_id, text) VALUES (10, '인생에서 가장 재미있게'|| char(10) ||'읽었던 책은 뭐야?');
insert into question(character_id, text) VALUES (10, '민트 초코 좋아해?');
insert into question(character_id, text) VALUES (10, '하루종일 침대에서 뒹굴거리면서'|| char(10) ||'하고 싶은 일 첫번째는?');
insert into question(character_id, text) VALUES (10, '친구들이랑 지금 당장'|| char(10) ||'하고 싶은 일은 뭐야?');
...
insert into question(character_id, text) VALUES (10, '고생한 나에게 작은 선물을'|| char(10) ||'한다면 뭘 선물하고 싶어?');
insert into question(character_id, text) VALUES (10, '경치 좋은 곳에 가서'|| char(10) ||'가장 하고 싶은 일이 뭐야?');
insert into question(character_id, text) VALUES (10, '집 인테리어를 하나 바꾼다면'|| char(10) ||'가장 바꾸고 싶은 것은?');
insert into question(character_id, text) VALUES (10, '내 방에 있는 것들 중에'|| char(10) ||'가장 좋아하는 것은?');
...
insert into question(character_id, text) VALUES (10, '가장 안 들킬 것 같은'|| char(10) ||'비상금 위치는 어딜까?');
insert into question(character_id, text) VALUES (10, '여름에 뜨거운 물로 샤워하니?');
insert into question(character_id, text) VALUES (10, '네가 여러 명이라면,'|| char(10) ||'어떤 일들을 할 것 같아?');
insert into question(character_id, text) VALUES (10, '네가 생각하는 가장 힐링 되는 상황은?');
insert into question(character_id, text) VALUES (10, '난 오늘 16시간 잤다~'|| char(10) ||'넌 오늘 얼마나 잤어?');
insert into question(character_id, text) VALUES (10, '스마트폰에서 네가 자주'|| char(10) ||'사용하는 앱은 뭐야?');
insert into question(character_id, text) VALUES (10, '오늘 뭐 입었어?'|| char(10) ||'그 옷 입은 이유가 뭐야?');
insert into question(character_id, text) VALUES (10, '넌 어떤 환경에서 잘 자?');
insert into question(character_id, text) VALUES (10, '오늘 너에게 있었던'|| char(10) ||'가장 인상적인 일은?');
...
-- 9,'팩폭이'
-- 10,'하차니'
insert into question(character_id, text) VALUES (5, '초능력이 한 가지 생긴다면,'|| char(10) ||'가장 가지고 싶은 초능력은?');
insert into question(character_id, text) VALUES (5, '로또 1등 당첨되면 가장 먼저 뭐 할 거야?');
insert into question(character_id, text) VALUES (5, '다른 사람의 생각을 읽을 수 있다면'|| char(10) ||'누구의 속마음을 읽고 싶어?');
insert into question(character_id, text) VALUES (5, '만화(웹툰) 주인공이 될 수 있다면'|| char(10) ||'어떤 만화의 주인공이 되고 싶어?');
insert into question(character_id, text) VALUES (5, '네가 해리포터의 등장인물이 된다면'|| char(10) ||'가장 하고 싶은 마법은?');
insert into question(character_id, text) VALUES (5, '과거의 너를 만난다면'|| char(10) ||'가장 전해주고 싶은 말은?');
insert into question(character_id, text) VALUES (5, '과거로 가서 역사를 바꿀 수 있다면'|| char(10) ||'가장 바꾸고 싶은 역사는?');
insert into question(character_id, text) VALUES (5, '딱 한 번 미래로 갈 수 있다면'|| char(10) ||'몇 년 후 미래를 보고 싶니?');
insert into question(character_id, text) VALUES (5, '외계 행성에 가서 외계인을 만난다면'|| char(10) ||'가장 하고 싶은 일은?');
insert into question(character_id, text) VALUES (5, '과거의 사람과 식사를 할 수 있다면'|| char(10) ||'가장 만나고 싶은 사람은?');
insert into question(character_id, text) VALUES (5, '아무리 먹어도 살이 안 찐다면'|| char(10) ||'무슨 음식을 먹고 싶어?');
insert into question(character_id, text) VALUES (5, '하루 동안 원하는 직업으로'|| char(10) ||'일할 수 있다면 뭘 할래?');
insert into question(character_id, text) VALUES (5, '어느 나라도 10초 만에 이동할 수 있다면'|| char(10) ||'너의 여행 계획은?');
insert into question(character_id, text) VALUES (5, '네가 세계정복을 하면'|| char(10) ||'가장 하고 싶은 일은?');
insert into question(character_id, text) VALUES (5, '동물이 된다면'|| char(10) ||'가장되고 싶은 동물은?');
insert into question(character_id, text) VALUES (5, '나를 위한 법을 만든다면?');
insert into question(character_id, text) VALUES (5, '네가 유명인이 된다면 어떤 삶을 살까?'|| char(10) ||'무엇으로 유명해진 걸까?');
insert into question(character_id, text) VALUES (5, '세계 3차 대전이 일어나다면,'|| char(10) ||'네가 가장 먼저 할 일은?');
insert into question(character_id, text) VALUES (5, '너가 여러 명이라면'|| char(10) ||'어떤 일들을 할 것 같아?');
insert into question(character_id, text) VALUES (5, '200살까지 살 수 있다면'|| char(10) ||'너의 인생 계획은?');
insert into question(character_id, text) VALUES (5, '무인도에 너 혼자 살아남는다면?'|| char(10) ||'너의 생존 계획은?');
insert into question(character_id, text) VALUES (5, '인류가 화성에서 살게 된다면'|| char(10) ||'너의 직업은 무엇일 것 같아?');
insert into question(character_id, text) VALUES (5, '영화나 드라마 주인공이 될 수 있다면'|| char(10) ||'어떤 주인공이 되고 싶어?');
insert into question(character_id, text) VALUES (5, '네가 날씨를 조종할 수 있다면'|| char(10) ||'내일의 날씨는?');
insert into question(character_id, text) VALUES (5, '사람이 잠을 안 자고도 살 수 있다면'|| char(10) ||'밤에 뭘 하고 싶어?');
insert into question(character_id, text) VALUES (5, '앞으로 100년 후의 미래는 어떤 모습일까?');
insert into question(character_id, text) VALUES (5, '동물들의 말을 알아들을 수 있다면'|| char(10) ||'무슨 대화를 어떤 동물과 하고 싶어?');
...
insert into question(character_id, text) VALUES (9, '새해에 해돋이를 보면서'|| char(10) ||'다짐하고 싶은 목표는?');
insert into question(character_id, text) VALUES (9, '운동은 하고 있어? 얼마나? 어떻게?');
insert into question(character_id, text) VALUES (9, '오늘 계획한 일은 잘 했니?'|| char(10) ||'얼마나 계획한 대로 성취했니?');
insert into question(character_id, text) VALUES (9, '오늘 방 청소는 했니?'|| char(10) ||'청소는 자주 하는 편이야?');
insert into question(character_id, text) VALUES (9, '남의 눈치를 본 경험이 있어?'|| char(10) ||'너는 그 경험이 좋았어?');
insert into question(character_id, text) VALUES (9, '과거에 노력을 좀 더 했다면'|| char(10) ||'지금 너의 모습은 어땠을까?');
insert into question(character_id, text) VALUES (9, '남들이 생각하는 너의 모습과'|| char(10) ||'네가 생각하는 너의 모습에 차이는?');
insert into question(character_id, text) VALUES (9, '저축을 매달 100만 원씩 할 수 있다면'|| char(10) ||'10년 후에 너의 모습은 어떨까?');
insert into question(character_id, text) VALUES (9, '살면서 정말 열심히 해본 일이 있어?');
insert into question(character_id, text) VALUES (9, '다른 사람의 의견 말고'|| char(10) ||'너의 생각대로만 했던 일이 있어?');
insert into question(character_id, text) VALUES (9, '너도 못하는 일을'|| char(10) ||'남에게 강요한 적이 있어?');
insert into question(character_id, text) VALUES (9, '가장 기억에 남았던 효도는?');
insert into question(character_id, text) VALUES (9, '난 요즘 책을 읽으며 수련하고 있지.'|| char(10) ||'오늘 너는 무엇을 배웠니?');
...
insert into question(character_id, text) VALUES (9, '최근에 가장 화났던 일은 뭐야?'|| char(10) ||'그 일이 왜 일어난 것 같아?');
insert into question(character_id, text) VALUES (9, '너는 다른 사람의 말을'|| char(10) ||'잘 들어주는 사람이니?');
insert into question(character_id, text) VALUES (9, '지금 가장 무거운 고민은 뭐야?'|| char(10) ||'해결 방법은 생각했니?');
insert into question(character_id, text) VALUES (9, '하겠다고 말만 하고'|| char(10) ||'시작도 못한 일이 있니?');
...
insert into question(character_id, text) VALUES (9, '가장 존경하는 사람은?'|| char(10) ||'그 사람과 너의 차이가 뭐라고 생각해?');
...
insert into question(character_id, text) VALUES (9, '오늘의 삶은 만족스러웠니?'|| char(10) ||'어떻게 해야 내일은 더 만족스러울 수 있을까?');
...
insert into question(character_id, text) VALUES (9, '내가 다른 사람보다 더 행복하다고'|| char(10) ||'느끼는 부분이 있다면?');
insert into question(character_id, text) VALUES (9, '네가 인생 명언을 만든다면 뭐라고 할래?');
insert into question(character_id, text) VALUES (9, '네 인생에서 가장 실패한 경험은?'|| char(10) ||'그 경험으로 뭘 알게 되었니?');
...
insert into question(character_id, text) VALUES (1, '내일 잘 해내지 못할 것 같은'|| char(10) ||'불안한 일이 있어?');
...
insert into question(character_id, text) VALUES (1, '전혀 걱정되지 않는 일이 있다면,'|| char(10) ||'이유가 뭘까?');
insert into question(character_id, text) VALUES (1, '오늘 자기 전에'|| char(10) ||'계속 생각날 것 같은 일은 뭐야?');
insert into question(character_id, text) VALUES (1, '후회되는 일이 있다면,'|| char(10) ||'어떻게 고쳐나갈 수 있을까?');
insert into question(character_id, text) VALUES (1, '지금 가장 신경 쓰는 일의 최악의 상황은 무엇일까?');
insert into question(character_id, text) VALUES (1, '지금 나를 불안하게 만드는'|| char(10) ||'근본적인 이유는 뭘까?');
...
insert into question(character_id, text) VALUES (1, '더 잘할 수 있었을 텐데 라고'|| char(10) ||'생각되는 일이 있어?');
...
insert into question(character_id, text) VALUES (1, '과거의 일 때문에'|| char(10) ||'아직 망설여지는 일이 있다면?');
...
insert into question(character_id, text) VALUES (1, '무심코 뱉은 말에 다른 사람을'|| char(10) ||'상처입힌 적이 있어?');
...
insert into question(character_id, text) VALUES (1, '가장 후회되는 일에서'|| char(10) ||'대처를 더 잘했다면 지금과 달라졌을까?');
insert into question(character_id, text) VALUES (1, '요즘 자꾸 신경 쓰이는 일이 있어?');
insert into question(character_id, text) VALUES (1, '다른 사람들이 나에 대해 말하는 것 중에'|| char(10) ||'어떤 게 가장 신경이 쓰여?');
-- 1,'뭉그리'
-- 2,'똘똘이',
-- 3,'달콩이'
-- 4,'부우'
...
insert into question(character_id, text) VALUES (2, '지금 가장 힘든 게 뭐야?'|| char(10) ||'어떻게 극복 할 예정이야?');
...
insert into question(character_id, text) VALUES (2, '미래를 위해 현재의'|| char(10) ||'나에게 가장 필요한 것은?');
insert into question(character_id, text) VALUES (2, '하루를 시작할 때'|| char(10) ||'가장 먼저 하는 일은?');
insert into question(character_id, text) VALUES (2, '다른 사람에게 가장 알려주고 싶은'|| char(10) ||'너의 계획 습관이 있어?');
insert into question(character_id, text) VALUES (2, '부모님에게 가장 해드리고 싶은'|| char(10) ||'효도는 뭐야?');
...
insert into question(character_id, text) VALUES (2, '지피지기 백전백승!'|| char(10) ||'너에 대해 알아보는 시간을 가져보자.');
insert into question(character_id, text) VALUES (2, '목표를 달성하기 위해 해야 되는 일을'|| char(10) ||'우선순위로 세워보자.');
insert into question(character_id, text) VALUES (2, '너의 목표를 이루기 위해'|| char(10) ||'바꿔야 할 주변 환경이 뭐가 있을까?');
insert into question(character_id, text) VALUES (2, '장기적으로 뭔가를 이루기 위해'|| char(10) ||'어떤 노력을 해봤어?');
insert into question(character_id, text) VALUES (2, '건강한 삶을 살기 위해'|| char(10) ||'어떤 노력을 하고 있어?');
insert into question(character_id, text) VALUES (2, '미래를 준비하기 위해'|| char(10) ||'하고 있는 자기 개발이 있어?');