...
class InfoScreen extends StatelessWidget {
  ...
  static const Map<String, String> _questionAnswerMap = {
    'Q. 몽글 마을의 이야기를 알려주세요!':
        'A. 몽글 마을에는 몽글이들이 행복하게 살고 있었어요. 몽글이들은 사람들의 추억을 먹으면서 살아가고 있었죠. 하지만 어느 날부턴가 추억을 남기는 습관들이 사라지기 시작했어요. 몽글이들은 점점 작아지고, 약해져 버렸어요. 10마리의 몽글이에게 여러분의 추억을 주고, 몽글 마을을 구해주세요.',
    'Q. 몽글 앱은 어떤 앱인가요?':
